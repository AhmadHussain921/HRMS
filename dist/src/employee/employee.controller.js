...
const department_service_1 = require("src/department/department.service");
const employee_dtos_1 = require("./employee.dtos");
const employee_service_1 = require("./employee.service");
const jwt_auth_gaurd_1 = require("../auth/jwt-auth.gaurd");
const mongoose_2 = require("mongoose");
const experience_service_1 = require("src/experience/experience.service");
const correctionReq_service_1 = require("src/correctionReq/correctionReq.service");
const designation_service_1 = require("src/designation/designation.service");
